  ...
  return (
    <>
      <nav
        className={
          shadow
            ? 'navbar navbar-expand-lg bg-light fixed-top position-relative h-auto shadow p-3 mb-2 bg-body rounded'
            : 'navbar navbar-expand-lg fixed-top position-relative h-auto p-3 mb-2'
        }
        id="nav-bar"
      >
        <div className="container-fluid p-2">
          ...
          >
            <img
              className="w-50"
              src="https://manojkonda01.github.io/webresume/data/img/mklogo2.png"
              alt="my-logo"
            />
          </div>
          <button
